...
class _AttendanceHistoryScreenState extends State<AttendanceHistoryScreen> {
  int selectedDay = 22; // Jour sélectionné par défaut (Mer)
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildCourseCard(
                            ...
                            'Romuald',
                            Color(0xFF4C51BF),
                            isPresent: false, // ✅ ou false pour absence
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildCourseCard(
    ...
    String teacher,
    Color accentColor, {
    bool isPresent = true, // ✅ nouvel argument optionnel
  }) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        ...
        children: [
          Row(
            children: [
              ...
              Icon(
                isPresent ? Icons.person : Icons.person_off, // ✅ dynamique
                color: isPresent ? accentColor : Colors.red,
                size: 20,
              ),
            ],
          ),
